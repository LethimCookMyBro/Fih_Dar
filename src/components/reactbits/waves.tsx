...
// Source: React Bits (@react-bits/Waves-TS-TW), https://reactbits.dev/backgrounds/waves
// Vendored from the free registry JSON (https://reactbits.dev/r/Waves-TS-TW.json) rather
// than pulled via the shadcn registry CLI (which shells out to bun, unavailable here).
// Adapted from the demo source: the cursor-follower dot (demo debug UI) is removed, and
// mouse interaction is made optional so it can be disabled entirely on the auth screen.
...
interface WavesProps {
  ...
  tension?: number;
  maxCursorMove?: number;
  /** When false, the field never reacts to pointer movement — no listeners attached. */
